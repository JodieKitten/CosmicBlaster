 ...
 */
//DYNAMIC functions will need to be UFUNCTION (in menu.h)
...
public:
	...
	/*
	Custom delegates for Menu class to bind to
	*/
...
private:
	...
	We'll bind the MultiplayerSessionSubsystem internal callbacks to these
	*/
