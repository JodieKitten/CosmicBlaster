...
{
	FVector ToTargetNormalized = (HitTarget - TraceStart).GetSafeNormal(); //from trace start to hit target
	FVector SphereCentre = TraceStart + ToTargetNormalized * DistanceToSphere;
	FVector RandVec = UKismetMathLibrary::RandomUnitVector() * FMath::FRandRange(0.f, SphereRadius);
	FVector EndLoc = SphereCentre + RandVec;
	FVector ToEndLoc = EndLoc - TraceStart;
	/*
	DrawDebugSphere(GetWorld(), SphereCentre, SphereRadius, 12, FColor::Red, true);
